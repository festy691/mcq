            ...
            child: Container(
              ...
              child: ListView(
                children: [
                  ...
                  Center(child: Text('Email Verification', style: GoogleFonts.adamina(color: Color(0xFF00642B), fontSize: 28.0, fontWeight: FontWeight.bold),)),
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: RaisedButton(
                                ...
                                child: Text('Validate Code', style: GoogleFonts.adamina(color: Colors.white),),
                                elevation: 2.0,
                                onPressed: () async {
