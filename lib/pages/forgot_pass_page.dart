  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(child: Text('Forgot Password', style: GoogleFonts.adamina(color: Color(0xFF00642B)),)),
        actions: [
          SizedBox(width: 50.0,),
        ],
      ),
            ...
            child: Container(
              ...
              child: ListView(
                children: [
                  ...
                  Center(child: Text('Forgot Password', style: GoogleFonts.adamina(color: Color(0xFF00642B), fontSize: 28.0, fontWeight: FontWeight.bold),)),

                  SizedBox(height: 32.0,),

                  Center(child: Text('Reset your Password', style: GoogleFonts.adamina(color: Color(0xFF00642B), fontSize: 28.0),)),
